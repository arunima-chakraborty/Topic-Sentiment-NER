...
class MultiTaskModel(nn.Module):
    def __init__(self):
        ...
        self.topic_classifier = nn.Linear(self.bert.config.hidden_size, self.classifiers["topic_label_map"]).cuda()
        self.ner_classifier = nn.Linear(self.bert.config.hidden_size, self.classifiers["ner_label_map"]).cuda()
        self.sentiment_classifier = nn.Linear(self.bert.config.hidden_size, self.classifiers["sentiment_label_map"]).cuda()
